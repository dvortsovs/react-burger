                ...
                <div className={`${appHeaderStyles.content}`}>
                    <nav className={`${appHeaderStyles.nav}`}>
                        <ul className={`${appHeaderStyles.list} mt-4 mb-4`}>
                            ...
                            <li className={``}>
                                <NavButton to={'/feed'} icon={'list'} title={'Лента заказов'}
                                           styles={"pt-4 pr-5 pb-4 pl-5"}/>
                            </li>
                        </ul>
                    </nav>
                    <Link to={'/'}><Logo/></Link>
                    <NavButton to={'/profile'} personal={true} icon={'profile'} title={'Личный кабинет'}
                               styles={"pt-4 pb-4 pl-5"}/>
                </div>
            </header>
            <main>
                <Outlet/>
